          ...
          <CardContent className="p-8 sm:p-10 space-y-8">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase font-black tracking-widest text-slate-500">
                <span className="bg-[#0A0A0B]/50 px-4">Ou continuer avec</span>
              </div>
            </div>

            {/* Social Login - SECONDAIRE */}
            <div className="grid grid-cols-2 gap-4">
              <Button 
                variant="outline" 
                className="h-14 rounded-2xl bg-white text-black hover:bg-slate-100 border-none font-black text-sm gap-2 transition-all active:scale-95 shadow-xl"
              ...
              <Button 
                variant="outline" 
                className="h-14 rounded-2xl bg-[#5865F2] text-white hover:bg-[#4752C4] border-none font-black text-sm gap-2 transition-all active:scale-95 shadow-xl shadow-[#5865F2]/20"
