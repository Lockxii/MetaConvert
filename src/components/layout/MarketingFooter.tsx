      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-2xl text-white tracking-tight">MetaConvert</span>
            </div>
            ...
            <div className="pt-2">
                <h5 className="text-sm font-semibold text-white mb-3">Restez informé</h5>
                <div className="flex gap-2 max-w-sm">
                    <Input 
                        placeholder="votre@email.com" 
                        className="bg-slate-900/50 border-slate-800 text-slate-300 placeholder:text-slate-600 focus-visible:ring-blue-500 focus-visible:border-blue-500"
                    />
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <li><Link href="/legal/terms" className="hover:text-blue-400 transition-colors">CGU</Link></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <li><Link href="mailto:support@metaconvert.com" className="hover:text-blue-400 transition-colors">Support Email</Link></li>
                </ul>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
           <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
               <p className="text-sm text-slate-500">© 2025 MetaConvert Inc. Tous droits réservés.</p>
